...
export class InputParameterSerializerGenerator implements OpenAPIGenerator {
  ...
  public initialize(data: OpenAPIReadOutput, generators: OpenAPIGenerator[]): void {
    ...
    this.generator = generateOperationParameterTypeSerializer(this.location, this.produced, this.consumed)
  }
