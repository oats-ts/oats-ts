...
import { ParameterTypesGeneratorConfig, ResponseParameterInput, ResponseParameterInputInternal } from '../typings'
...
export class ResponseHeaderTypesGenerator extends BaseCodeGenerator<
  OpenAPIReadOutput,
  SourceFile,
