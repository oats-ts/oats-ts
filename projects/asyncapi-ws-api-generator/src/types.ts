export type ApiGeneratorConfig = {
  /**
   * When true, a type (interface) will be generated with all the channels.
   * This is reuseable, where you only need type signatures, but no implementation detail.
   */
  type: boolean
  /**
   * When true, a class will be generated with all the channels. The class takes
   * A configuration as constructor argument, and has all the channel methods with
   * a simplified signature (config can be ommited). If type set to true, it also
   * declares that it implements above type.
   */
  class: boolean
  /**
   * When true, a class will be generated with all the channels. The methods call
  ...
  stub: boolean
  /**
   * If set to true, the summary, description and deprecated fields in ChannelObjects will be used
