...
import { getExpressRouterCorsHandlerAst } from './getExpressRouterCorsHandlerAst'
  ...
  return factory.createCallExpression(
    factory.createPropertyAccessExpression(
      factory.createCallExpression(
        ...
        undefined,
        [factory.createStringLiteral(url), getExpressRouterCorsHandlerAst(data, context, config)],
      ),
