...
import { createHttpMethodsRoute, HttpMethodsClientSdk, HttpMethodsSdk } from '../../generated/HttpMethods'
import { HttpMethod } from '@oats-ts/openapi-http'

describe('Http methods', () => {
  manageServerLifecycle(createHttpMethodsRoute(new HttpMethodsApiImpl(), new ExpressServerConfiguration()))
