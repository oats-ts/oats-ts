...
import { HeaderParameters as _HeaderParameters, parameter as _parameter } from '@oats-ts/openapi-runtime'
import { SimpleHeaderParametersRequestHeaderParameters } from './requestHeaderTypes'

export const simpleHeaderParametersRequestHeaderParameters: _HeaderParameters<SimpleHeaderParametersRequestHeaderParameters> =
  {
    descriptor: {
      ...
      'X-EnmExpl-Header': _parameter.header.simple.exploded.required.primitive(
        _parameter.value.string(_parameter.value.enum(['A', 'B', 'C'])),
      ),
      'X-OptEnmExpl-Header': _parameter.header.simple.exploded.primitive(
        _parameter.value.string(_parameter.value.enum(['A', 'B', 'C'])),
      ),
      'X-Enm-Header': _parameter.header.simple.required.primitive(
        _parameter.value.string(_parameter.value.enum(['A', 'B', 'C'])),
      ),
      'X-OptEnm-Header': _parameter.header.simple.primitive(
        _parameter.value.string(_parameter.value.enum(['A', 'B', 'C'])),
      ),
      ...
      'X-EnmArrExpl-Header': _parameter.header.simple.exploded.required.array(
        _parameter.value.string(_parameter.value.enum(['A', 'B', 'C'])),
      ),
      'X-OptEnmArrExpl-Header': _parameter.header.simple.exploded.array(
        _parameter.value.string(_parameter.value.enum(['A', 'B', 'C'])),
      ),
      'X-EnmArr-Header': _parameter.header.simple.required.array(
        _parameter.value.string(_parameter.value.enum(['A', 'B', 'C'])),
      ),
      'X-OptEnmArr-Header': _parameter.header.simple.array(
        _parameter.value.string(_parameter.value.enum(['A', 'B', 'C'])),
      ),
      ...
      'X-OptObjExpl-Header': _parameter.header.simple.exploded.object({
        ...
        optObjExplOptEnmField: _parameter.value.optional(
          _parameter.value.string(_parameter.value.enum(['A', 'B', 'C'])),
        ),
      }),
