 ...
 * 
 * Generated from https://raw.githubusercontent.com/oats-ts/oats-schemas/master/tuple-schemas.json
 */
...
export const tupleTypeTypeValidator = array(
  tuple(
    ...
    optional(lazy(() => referenceTargetTypeValidator)),
  ),
)
...
export function isTupleType(input: any): input is TupleType {
  return (
    ...
    (input[5] === null || input[5] === undefined || isReferenceTarget(input[5]))
  )
}
