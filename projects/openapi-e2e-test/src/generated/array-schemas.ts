 ...
 * 
 * Generated from https://raw.githubusercontent.com/oats-ts/oats-schemas/master/array-schemas.json
 */
...
export const objectArrayTypeTypeValidator = array(items(object(shape({ foo: optional(string()) }))))
  ...
  return (
    ...
    input.every(
      (item: any) =>
        item !== null &&
        typeof item === 'object' &&
        (item.foo === null || item.foo === undefined || typeof item.foo === 'string'),
    )
  )
}
