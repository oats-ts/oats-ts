...
import { Transform, DslConfig, CookieDslRoot, ParameterType } from './types'
...
export function createCookieDeserializers<T extends ParameterType>(root: CookieDslRoot<T>) {
